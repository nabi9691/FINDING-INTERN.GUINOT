...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('sSfDrxJnKU', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-TnFyyfy-i', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('thgb85a4AH', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('k+nmpmRSlP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZURumb12GY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('32lxoAKVLk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ze56YLFDDO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHoldere388b = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializera276d = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties2c85a = [
        
    ];

    public function getConnection()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'getConnection', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'getMetadataFactory', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'getExpressionBuilder', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'beginTransaction', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->beginTransaction();
    }

    public function getCache()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'getCache', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->getCache();
    }

    public function transactional($func)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'transactional', array('func' => $func), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'wrapInTransaction', array('func' => $func), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'commit', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->commit();
    }

    public function rollback()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'rollback', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'getClassMetadata', array('className' => $className), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'createQuery', array('dql' => $dql), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'createNamedQuery', array('name' => $name), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'createQueryBuilder', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'flush', array('entity' => $entity), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'clear', array('entityName' => $entityName), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->clear($entityName);
    }

    public function close()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'close', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->close();
    }

    public function persist($entity)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'persist', array('entity' => $entity), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'remove', array('entity' => $entity), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'refresh', array('entity' => $entity), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'detach', array('entity' => $entity), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'merge', array('entity' => $entity), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'getRepository', array('entityName' => $entityName), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'contains', array('entity' => $entity), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'getEventManager', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'getConfiguration', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'isOpen', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'getUnitOfWork', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'getProxyFactory', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'initializeObject', array('obj' => $obj), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'getFilters', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'isFiltersStateClean', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'hasFilters', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return $this->valueHoldere388b->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializera276d = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHoldere388b) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHoldere388b = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHoldere388b->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, '__get', ['name' => $name], $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        if (isset(self::$publicProperties2c85a[$name])) {
            return $this->valueHoldere388b->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHoldere388b;
    ...
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, '__set', array('name' => $name, 'value' => $value), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;
    ...
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, '__isset', array('name' => $name), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;
    ...
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, '__unset', array('name' => $name), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;
    ...
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, '__clone', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        $this->valueHoldere388b = clone $this->valueHoldere388b;
    }

    public function __sleep()
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, '__sleep', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        return array('valueHoldere388b');
    }
    ...
    {
        $this->initializera276d = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializera276d;
    }

    public function initializeProxy() : bool
    {
        return $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'initializeProxy', array(), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHoldere388b;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHoldere388b;
    }
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializera276d && ($this->initializera276d->__invoke($valueHoldere388b, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializera276d) || 1) && $this->valueHoldere388b = $valueHoldere388b;

        if ($this->valueHoldere388b === $returnValue = $this->valueHoldere388b->paginate($target, $page, $limit, $options)) {
            return $this;
        }
